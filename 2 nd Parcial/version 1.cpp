...
public:
    ...
    void Ordenar_los_datos_por_el_Registro_Total_de_Lluvias_por_region();
...
void rain::Ordenar_los_datos_por_el_Registro_Total_de_Lluvias_por_region()
{
...
int main()
{
    ...
    string path_2 = "C:/UNI/2 nd Parcial/texto 2.txt";
